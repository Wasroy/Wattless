      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-lg text-zinc-400 mb-3 max-w-md">
            You&rsquo;re paying <span className="line-through text-zinc-300">$3.67/h</span> for an A100.
        ...
        >
          <Link to="/mapmonde" className="group block relative">
            ...
            <div className="absolute inset-0 flex items-end justify-center pb-6 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
              <span className="text-xs font-medium text-foreground bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full border border-zinc-200 shadow-sm">
